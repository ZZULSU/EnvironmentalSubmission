...
data = pd.read_csv('../zfourth_threshold_32_6000_data/yield_piecewise_X_6000_threshold32.csv')
data = data.dropna()
data.to_csv('../zfourth_threshold_32_6000_data/yield_piecewise_X_6000_threshold32', index=False)
...
data.to_csv('../zfourth_threshold_32_6000_data/clustered_data_X.csv', index=False)


# Load your dataset into a Pandas DataFrame
df = pd.read_csv('../zfourth_threshold_32_6000_data/clustered_data_X.csv')
...
df1 = pd.read_csv('../zfourth_threshold_32_6000_data/clustered_data_X.csv')
# Load the zfourth dataset
df2 = pd.read_csv('../zfourth_threshold_32_6000_data/yield_piecewise_Y_6000.csv')
...
df2.to_csv('../zfourth_threshold_32_6000_data/yield_piecewise_Y_6000_with_cluster.csv', index=False)

data = pd.read_csv('../zfourth_threshold_32_6000_data/yield_piecewise_Y_6000_with_cluster.csv')
data = data.dropna()

yield_1960 = data.iloc[:, 0]
yield_2000 = data.iloc[:, 1]

increase_absolute = yield_2000 - yield_1960
data['difference'] = increase_absolute

data.drop(data.columns[[0, 1]], axis=1, inplace=True)

data.to_csv('../zfourth_threshold_32_6000_data/increase_rate_with_cluster_6000.csv', index=False)
...
print(f"Mean of 'difference' in second DataFrame: {mean_df2}")

# Perform an independent samples t-test
t_statistic, p_value = stats.ttest_ind(cluster_1['difference'], cluster_2['difference'])
