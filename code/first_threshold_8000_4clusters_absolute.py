...
data = pd.read_csv('../first_threshold_8000_data/yield_piecewise_X_8000.csv')
...
data.to_csv('../first_threshold_8000_data/clustered_data_X.csv', index=False)


# Load your dataset into a Pandas DataFrame
df = pd.read_csv('../first_threshold_8000_data/clustered_data_X.csv')
...
df1 = pd.read_csv('../first_threshold_8000_data/clustered_data_X.csv')
# Load the second dataset
df2 = pd.read_csv('../first_threshold_8000_data/yield_piecewise_Y_8000.csv')
...
df2.to_csv('../first_threshold_8000_data/yield_piecewise_Y_8000_with_cluster.csv', index=False)
...
data.to_csv('../first_threshold_8000_data/increase_rate_with_cluster_8000.csv', index=False)
